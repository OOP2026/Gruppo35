...
public class GUIrichiestaspostamentolezione extends JPanel {	// Pannello interno per il modulo di richiesta spostamento lezioni
    private JTextField Data;			// Campo di testo per inserire il giorno della lezione
    private JTextField OraInizio;		// Campo di testo per l'orario di inizio della lezione
    private JTextField OraFine;			// Campo di testo per l'orario di fine della lezione
    private JButton InviaRichiesta;		// Bottone per confermare l'invio della richiesta al responsabile
    private JButton Annulla;			// Bottone per annullare l'operazione e tornare alla schermata precedente
